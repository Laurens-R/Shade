...
namespace shade {
    ...
    class cstring {
        ...
        public:
            ...
            [[nodiscard]] auto ends_with(const cstring &str) const -> bool;

            [[nodiscard]] auto substring(size_t start, size_t end) const -> cstring;
            ...
            /// @brief Whether the text is a valid integer in hex form.
            [[nodiscard]] auto is_hex_integer() const -> bool;

            /// @brief Whether the text is a valid integer in binary form.
            [[nodiscard]] auto is_binary_integer() const -> bool;
