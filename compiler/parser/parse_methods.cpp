...
namespace shade {
    ...
    void parse_methods::init() {
        static bool are_parsers_initialized = false;

        if (are_parsers_initialized) {
            return;
        }

        attributes.match_and_capture_token(spelling::attributes::attr_indicator, range_keys::attribute_indicator)
        ...
        modules.match_and_capture_token(spelling::modules::keyword_module, range_keys::module_keyword)
        ...
        structs.match_and_capture_token(spelling::structs::keyword_struct, range_keys::struct_keyword)
        ...
        functions.match_and_capture_token(spelling::functions::keyword_func, range_keys::function_keyword)
        ...
        if_conditional.match_and_capture_token(spelling::conditional::keyword_if, range_keys::if_keyword)
        ...
        if_else_conditional.match_and_capture_token(spelling::conditional::keyword_else, range_keys::else_keyword)
                           .match_and_capture_token(spelling::conditional::keyword_if, range_keys::if_keyword)
        ...
        else_conditional.match_and_capture_token(spelling::conditional::keyword_else, range_keys::else_keyword)
        ...
        for_loop.match_and_capture_token(spelling::loops::keyword_for, range_keys::for_loop_keyword)
        ...
        while_loop.match_and_capture_token(spelling::loops::keyword_while, range_keys::while_loop_keyword)
        ...
        raw_scope.capture_range(spelling::scopes::begin_body, spelling::scopes::end_body, range_keys::raw_scope)
                 .set_type(range_keys::raw_type_key);

        statements.take_token_until(spelling::actions::end_of_statement, range_keys::statement_expression)
                  .set_type(range_keys::statement_type_key);

        type_expressions.optional_match_and_capture_token(spelling::types::keyword_owning, range_keys::type_expression_owning)
                        .optional_match_and_capture_token(spelling::types::keyword_constant, range_keys::type_expression_constant)
                        .optional_match_and_capture_token(spelling::types::keyword_reference, range_keys::type_expression_reference)
                        .optional_match_and_capture_token(spelling::types::keyword_pointer, range_keys::type_expression_pointer)
    ...
    parse_methods & parse_methods::get_instance() {
        static parse_methods instance;
        return instance;
    }
} // shade
