...
namespace shade {
    ...
    void parse_methods::init() {
        ...
        modules.match_and_capture_token(spelling::modules::module_name, range_keys::module_keyword)
        ...
        structs.match_and_capture_token(spelling::structs::struct_indicator, range_keys::struct_keyword)
        ...
        functions.match_and_capture_token(spelling::functions::func_indicator, range_keys::function_keyword)
        ...
        if_conditional.match_and_capture_token(spelling::conditional::if_start, range_keys::if_keyword)
        ...
        if_else_conditional.match_and_capture_token(spelling::conditional::if_else, range_keys::else_keyword)
        ...
        else_conditional.match_and_capture_token(spelling::conditional::if_else, range_keys::else_keyword)
        ...
        for_loop.match_and_capture_token(spelling::loops::loop_for, range_keys::for_loop_keyword)
        ...
        while_loop.match_and_capture_token(spelling::loops::loop_while, range_keys::while_loop_keyword)
        ...
        type_expressions.optional_match_and_capture_token(spelling::types::owning, range_keys::type_expression_owning)
