...
namespace shade {
    namespace spelling {
        ...
        namespace actions {
            ...
            inline constexpr const char *keyword_return = "return";
        }

        namespace variables {
            inline constexpr const char *assignment = "=";
            inline constexpr const char *literal_null = "null";
            inline constexpr const char *keyword_auto_type = "var";
        }
        ...
        namespace modules {
            inline constexpr const char *keyword_module = "module";
        ...
        namespace structs {
            inline constexpr const char *keyword_struct = "struct";
            inline constexpr const char *begin_body = scopes::begin_body;
            inline constexpr const char *end_body = scopes::end_body;
        }

        namespace functions {
            inline constexpr const char *keyword_func = "func";
        ...
        namespace conditional {
            inline constexpr const char *keyword_if = "if";
            inline constexpr const char *keyword_else = "else";
        ...
        namespace loops {
            inline constexpr const char *keyword_for = "for";
            inline constexpr const char *keyword_foreach = "foreach";
            inline constexpr const char *keyword_while = "while";
        ...
        namespace types {
            inline constexpr const char *keyword_owning = "owned";
            inline constexpr const char *keyword_constant = "const";
            inline constexpr const char *keyword_reference = "ref";
            inline constexpr const char *keyword_pointer = "ptr";
            inline constexpr const char *keyword_string = "string";
