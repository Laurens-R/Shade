...
namespace shade {
    ...
    namespace spelling {
        ...
        namespace scopes {
            inline constexpr const char* begin_scope = "{";
            inline constexpr const char* end_scope = "}";
        }
        ...
        namespace modules {
            ...
            inline constexpr const char* begin_scope = groups::begin_group;
            inline constexpr const char* end_scope = groups::end_group;
        }

        namespace structs {
            inline constexpr const char* struct_indicator = "struct";
            inline constexpr const char* struct_begin_scope = scopes::begin_scope;
            inline constexpr const char* struct_end_scope = scopes::end_scope;
        }
        ...
        namespace functions {
            ...
            inline constexpr const char* func_start_arguments = groups::begin_group;
            inline constexpr const char* func_end_arguments = groups::end_group;
            ...
            inline constexpr const char* func_begin_scope = scopes::begin_scope;
            inline constexpr const char* func_end_scope = scopes::end_scope;
        }
        ...
        namespace conditional {
            ...
            inline constexpr const char* begin_scope = scopes::begin_scope;
            inline constexpr const char* end_scope = scopes::end_scope;
        ...
        namespace loops {
            ...
            inline constexpr const char* start_conditions = groups::begin_group;
